...
```
cd existing_repo
git remote add origin https://gitlab.com/webshipco/webshipco-automated-testing.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/webshipco/webshipco-automated-testing/-/settings/integrations)
